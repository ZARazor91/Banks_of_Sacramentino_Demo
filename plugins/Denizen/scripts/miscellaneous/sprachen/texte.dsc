lang:
  ...
  d_help:
    ger: <red>- Verfügbare Befehle -<white><&nl>/bos      Zeigt die BoS-Einführung<&nl>/time     Zeigt die aktuelle Uhrzeit<&nl>/money  Zeigt deinen aktuellen Kontostand<&nl>/pass     Zum Eingeben eines Passwortes<&nl>/stop     Speichert und beendet das Adventure
    eng: <red>- Available commands -<white><&nl>/bos      Shows the BoS-Introduction<&nl>/time     Shows the current time<&nl>/money  Shows your current bank balance<&nl>/pass     To enter a password<&nl>/stop     Saves and ends the adventure
  ...
  d_bos_trade:
    ...
    eng: <&nbsp><&nl> <red>- Trading -<white><&nl> <&gt> Buy<&co> Right-click the merchant. Left-click the item to buy, you can find the price in the tooltip.<&nl><&nl> <&gt> Sell<&co> Crouch (default is Shift) + right-click the merchant. Click the item in his inventory to sell it, you can find his offer in the tooltip.
  d_bos_hints:
